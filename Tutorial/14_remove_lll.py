    ...
    def train_model(self, n_batch, batch_labels_list=None):
        ...
        for epoch in tqdm(range(self.epochs), desc="Epochs"):
            for batch_id in range(n_batch):
                ...
                # 总损失
                loss = loss_cluster + loss_kl + self.loss_contrastive_weight * loss_contrastive
...
def main():
    ...
    output_file = '../data/DLPFC/output/different_samples_2'
    ...
    node_model.save_model('new_model_2.pth')
